...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    NSInteger c = [NSUserDefaults.standardUserDefaults integerForKey:@"didFinishLaunchingWithOptions"];
    [[NSUserDefaults standardUserDefaults] setInteger:(c+1) forKey:@"didFinishLaunchingWithOptions"];
//    if (c%100 == 15 || c%50 == 16 || c%50 == 14) {
//        exit(0);
//    }
    //替换为您自己的Bugly账户。
...
- (void)setupNavBar {
    [WFCUConfigManager globalManager].naviBackgroudColor = COLOR(0x000000);
    ...
    [[UISearchBar appearance] setSearchFieldBackgroundImage:[UIImage imageNamed:@"Fav_Text_Detail_Bg.png"]forState:UIControlStateNormal];
    [[UISearchBar appearance] setBackgroundImage:[UIImage new]];
    [UITabBar appearance].translucent = NO;
    [[UITabBar appearance] setBarTintColor:COLOR(0x0E0E0E)];
